...
for ax, G, ttl, vlim, cmap in [
    (axes[0], spi,  'A — SPI-12 (precipitation only)', 2.5, 'RdBu'),
    (axes[1], spei, 'B — SPEI-12 (precipitation − PET: temperature effect included)', 2.5, 'RdBu'),
    (axes[2], diff, 'C — Difference: SPEI-12 − SPI-12  (red = warming aggravates drought)', 1.2, 'RdBu')]:
...
plt.tight_layout()
plt.savefig(W + "figs_EN/Fig2_spi_spei_heatmaps.png", dpi=300, bbox_inches='tight')
